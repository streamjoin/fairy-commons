...
[[ -n "${__FAIRY_COMMONS_LIB_ARGUMENT_UTILS_SH__+x}" ]] && return
readonly __FAIRY_COMMONS_LIB_ARGUMENT_UTILS_SH__=1

# Include dependencies
[[ -n "${FAIRY_COMMONS_HOME+x}" ]] || readonly FAIRY_COMMONS_HOME="$(cd "$(dirname -- "${BASH_SOURCE[0]}")" && pwd -P)/.."
